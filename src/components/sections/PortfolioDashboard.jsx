...
const SOCIALS = [
    ...
    {
        name: "HuggingFace", url: "https://huggingface.co/Samay-AI-Verse",
        customIcon: (
            <svg width="22" height="22" viewBox="0 0 475 439" className="transition-transform group-hover:scale-110">
    ...
    {
        name: "LeetCode", url: "https://leetcode.com/samay-ai",
        customIcon: (
