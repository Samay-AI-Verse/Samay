...
const INNOVATIONS = [
    {
        ...
        color: "#e87532",
        github: "https://github.com/Samay-AI-Verse/Shivanya-Care",
...
export default function InnovationSection() {
    return (
        <section id="innovation-section" className="w-full py-32 bg-[#050505] text-[#f4ede6] relative overflow-hidden">
            ...
            <div className="max-w-[1240px] mx-auto px-6 mb-20 text-center md:text-left">
            ...
            <div className="max-w-[1240px] mx-auto px-6 flex flex-nowrap overflow-x-auto md:overflow-visible md:grid md:grid-cols-3 gap-8 justify-center pb-8 no-scrollbar">
                {INNOVATIONS.map((item, i) => (
                    <div key={i} className="innovation-anim min-w-[300px] flex justify-center">
